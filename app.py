...
correct_size = (512,512) ## Will be used to process the uploaded image to the correct size to work with efficientnet_b4
...
def evaluation(loaded_image,trained_model):
    try:
        ...
        input_tensor = transform(loaded_image).unsqueeze(0)
        ...
        with torch.no_grad():
            ...
            return (disease_classification[topclass.item()], topprob.item(), class_prob.numpy())
